...
# NAME Word Clock w timezone
# DESC No hands!
# Changes to add tz_offset in the code by Paulus Schulinck (Github handle: @PaulskPt)
# See lines 105-112
import time
...
def update():
    ...
    try:
        # --- code changes by @PaulskPt --- added timezone offset functionality
        sec = ntptime.time()
...
def draw():
    ...
    if time_string is None:
        print(f"Error: time_string = {time_string}")
    else:
        for word in words:
